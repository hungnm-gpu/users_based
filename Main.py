...
class CF(object):
    ...
    def __init__(self, data_matrix, k = 2, dist_func=cosine_similarity, uuCF=1):
        ...
        Khởi tạo CF với các tham số đầu vào:
            ...
            k: số lượng láng giềng lựa chọn để dự đoán rating. Mặc định 5
    ...
    def normalize_matrix(self):
        ...
        # self.mu là vector 0 với độ dài bằng vector users
        ...
        for n in range(self.n_users):
            ...
            # take mean(tinh trung bình cộng theo cột users)
            m = np.mean(ratings)
            if np.isnan(m):
    ...
    # ở phần khởi tạo class, ta đã gán: dist_func=cosine_similarity
    def similarity(self):
        """
    ...
    def recommend(self, u):
        """
        Xác định tất cả các mục nên được đề nghị cho người dùng u.
        Dự đoán dựa trên:
        self.pred (u, i)> 0. Giả sử xem xét các mục chưa được xếp hạng bởi u.
        """
